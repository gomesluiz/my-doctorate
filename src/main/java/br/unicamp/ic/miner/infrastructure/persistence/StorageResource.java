...
/**
 * The <code>StorageResource</code> class stores any number of
 * <code>String</code> objects and allows access to these stored values one at a
 * time, using the method <code>data</code>. These strings can then be iterated
 * over in the order they were added using a <code>for</code> loop.
 * 
 * <P>
 * This class mirrors an <code>ArrayList&lt;String&gt;</code> in some
 * functionality, but is simpler to use and fits the Duke/Coursersa model of
...
public class StorageResource {
	...
	/**
	 * Create a <code>StorageResource</code> object, loaded with the Strings
	...
	/**
	 * Create an <code>StorageResource</code> object that is a copy of another
	 * list.
	 * 
	 * @param other
	 *            the original list being copied
	 */
