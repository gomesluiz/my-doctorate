		...
		List<Dataset> datasets = Arrays.asList(
				new Dataset(
				 ...
				 , new Dataset("ooo" 
						...
						, 15000
						, CrawlerFactory.BTS_BUGZILLA)
				 , new Dataset("freedesktop" 
						, "https://bugs.freedesktop.org/show_bug.cgi?ctype=xml&id=%d"
						, "/home/luiz/Workspace/issue-crawler/data/freedesktop/xml/"
						, "xml"
						...
						, CrawlerFactory.BTS_BUGZILLA)
				 , new Dataset("gnome" 
						, "https://bugzilla.gnome.org/show_bug.cgi?ctype=xml&id=%d"
						, "/home/luiz/Workspace/issue-crawler/data/gnome/xml/"
						, "xml"
						...
						, CrawlerFactory.BTS_BUGZILLA)
				  , new Dataset("winehq" 
						, "https://bugs.winehq.org/show_bug.cgi?ctype=xml&id=%d"
						, "/home/luiz/Workspace/issue-crawler/data/winehq/xml/"
						, "xml"
				   ...
				   ,new Dataset("opennlp" 
							...
							, "/home/luiz/Workspace/issue-crawler/data/opennlp/xml/"
							, "xml"
