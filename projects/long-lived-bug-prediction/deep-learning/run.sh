...
nvidia-docker run -d -it --ipc=host --userns=host -v ${SHAREDIR}:${SHAREDIR} --workdir ${WORKDIR} ${IMAGE}:latest python3 -u /home/lgomes/experiments/long-lived-bug-prediction-w-dnn.py
