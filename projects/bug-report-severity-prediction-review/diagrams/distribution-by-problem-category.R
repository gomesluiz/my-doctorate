...
categories = c("SNS" , "SNSWD" , "MC", "MCWD", "BNB")
...
papers.all=list(  SNS=unique(papers.c1$value)
                , SNSWD=unique(papers.c2$value)
                , MC=unique(papers.c3$value)
                , MCWD=unique(papers.c4$value)
                , BNB=unique(papers.c5$value))
