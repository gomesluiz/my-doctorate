...
categories = c("Character" , "Concept" , "Term")
...
papers.all=list(  Character=unique(papers.c1$value)
                , Concept=unique(papers.c2$value)
                , Term=unique(papers.c3$value))
