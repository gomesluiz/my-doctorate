...
%\mario{\\ achei melhor remover. Isto ja esta apresentado mais pra frente.}
...
%The average of CRs by projects was 775 and The f-measures have gotten by severity level were: (2) 78\%-86\%; (3) 68\%-98\%; (4) 86\%-92\%. Severity level 1 and 5 were excluded from experiment because there was zero or few CRC with this levels.
...
\begin{table*}[!ht]
	...
	\begin{tabular}{l|c|c|c|c|c|}
		...
		\hline\cline{2-6}
        \multicolumn{1}{ |c| }{\multirow{5}{*}{\rotatebox[origin=c]{90}{\small{Menzies\cite{Menzies2008}}}}} & 
        \multirow{5}{*}{NA} & pitsA & 14-71 & RIPPER & \\
		\cline{3-6}
		\multicolumn{1}{ |c| }{} &  & pitsB &  42-90 & RIPPER & \\
		\cline{3-6}
		\multicolumn{1}{ |c| }{} &  & pitsC & 53-92 & RIPPER & \\
		\cline{3-6} 
		\multicolumn{1}{ |c| }{} &  & pitsD & 87-99 & RIPPER & \\
		\cline{3-6} 
		\multicolumn{1}{ |c| }{} &  & pitsE & 8-80 & RIPPER & \\
		%\cline{2-6} 
		\hline\hline 
		\multicolumn{1}{ |c| }{\multirow{5}{*}{\rotatebox[origin=c]{90}{\small{Lamkanfi\cite{Lamkanfi2010}}}}} &  & 4.950 & 83.333 & 9.345 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 16.283 & 76.470 & 26.850 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 98.308 & 67.387 & 79.963 & 0 \\
		\cline{2-6} 
		\multicolumn{1}{ |c| }{} &  & 30.357 & 100.000 & 46.575 & 0\\
		\cline{2-6} 
	    \multicolumn{1}{ |c| }{} &  & 25.130 & 81.355 & 38.400 & 0\\
		%\cline{2-6} 
		\hline\hline 
		...
		%\cline{2-6} 
		\hline\hline 
		\multicolumn{1}{ |c| }{\multirow{5}{*}{\rotatebox[origin=c]{90}{\small{Valdivia\cite{ValdiviaGarcia2014}}}}} &  & 6.930 & 70,000 & 12.612 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 16.283 & 77.227 & 26.896 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 95.478 & 67.166 & 78.857 & 0\\
		...
		%\cline{2-6} 
		\hline\hline 
		\multicolumn{1}{ |c| }{\multirow{5}{*}{\rotatebox[origin=c]{90}{\small{Tian\cite{Tian2012}}}}} &  & 6.930 & 70,000 & 12.612 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 16.283 & 77.227 & 26.896 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 95.478 & 67.166 & 78.857 & 0\\
		...
		%\cline{2-6} 
		\hline\hline 
		\multicolumn{1}{ |c| }{\multirow{5}{*}{\rotatebox[origin=c]{90}{\small{Ours}}}} &  & 6.930 & 70,000 & 12.612 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 16.283 & 77.227 & 26.896 & 0\\
		\cline{2-6}
		\multicolumn{1}{ |c| }{} &  & 95.478 & 67.166 & 78.857 & 0\\
