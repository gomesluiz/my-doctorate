...
%		\hline\hline 
		...
		%\cline{2-6} 
		\hline\hline 
		\multicolumn{1}{ |c| }{\multirow{3}{*}{\rotatebox[origin=c]{90}{\small{Tian\cite{Tian2012}}}}} & Is the bug report blocker & OpenOffice & 12.3-74.0 & INSPect\\
		\cline{3-5}
		...
		%\cline{2-6} 
		\hline\hline 
		\multicolumn{1}{ |c| }{\multirow{3}{*}{\rotatebox[origin=c]{90}{\small{Ours}}}} &  Will the CR severity level change? & HADOOP & 96.7 & Random Forest\\
		\cline{2-5}
