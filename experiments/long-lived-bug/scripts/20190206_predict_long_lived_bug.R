...
metrics.file  <- file.path(output.path, format(Sys.time(), "%Y%m%d%H%M%S_predic_ll_bug_one_threshold_eval.csv"))
...
reports.file <- file.path(dataset.path, "20190201_eclipse_bug_reports.csv")
...
source <- reports[, c('bug_id', "long_description")]
